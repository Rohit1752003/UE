...
const PlaceDetails = () => {
  ...
  useEffect(() => {
    ...
    getPlaceDetails(type, id, source)
      .then((data) => {
        ...
        <>
          ...
          <div className="container mx-auto px-4 pt-4">
            ...
            <p className="my-2 text-sm flex flex-wrap leading-relaxed">
              ...
              {/* --- */}
              {/* Place Ranking and Place Price Level */}~ {place?.ranking} ~ {place?.price_level}
              {/* --- */}
            </p>
              ...
              <div className="md:col-span-6 xl:col-span-4 bg-white border border-gray-200 p-4 my-1 mx-0 shadow-sm">
                ...
                {reviews ? (
                  <>
                    ...
                    {place?.num_reviews > 0 ? (
                      reviews?.map((review, i) => <Review key={i} review={review} place={place?.name} />)
                    ) : (
                      // No Review Message - At this stage the current place has no reviews
                      <p className="text-gray-300 text-center">There are currently no reviews for this place.</p>
                    )}
                    {/* --- */}
                  </>
                ) : (
