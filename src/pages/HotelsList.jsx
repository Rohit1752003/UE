...
const HotelsList = () => {
  ...
  useEffect(() => {
    ...
    getPlacesByLatLng("hotels", coordinates.lat, coordinates.lng, { ...filterParams }, source).then((data) => {
    ...
    <>
      ...
      <div className="pb-4">
        <div className="container mx-auto text-center my-10">
          <h1 className="font-semibold text-lg md:text-3xl">Hotels and Places to stay</h1>
        </div>
        ...
        <div className={`${scrolled && "border-b"} mb-10 z-30 md:sticky-top bg-white -mt-4`}>
          <div className="container mx-auto block space-y-4 md:space-y-0 md:grid md:grid-cols-3 gap-2 px-4 py-5">
            ...
            <div className="w-full relative">
              <span className="absolute text-xs bg-white font-semibold px-2 -top-2 left-2">Check In</span>
              ...
              <Input
                ...
                handleChangeInline={(e) =>
                  setFilterParams((prevState) => ({
                    ...
                    nights: Number(
                      moment(new Date(filterParams.checkout)).diff(moment(new Date(e.target.value)), "days"),
                    ),
                  }))
                }
                ...
                // CSS Classes Props
                classProps="w-full rounded border-y border-r shadow px-4 py-2 border-l-8 border-l-cyan-600 focus:text-gray-700 focus:bg-white focus:border-cyan-600 focus:outline-none transition-all duration-300"
              />
              {/* --- */}
            </div>
            {/* --- */}
            ...
            {/* Check Out */}
            <div className="w-full relative">
              <span className="absolute text-xs bg-white font-semibold px-2 -top-2 left-2">Check Out</span>
              ...
              <Input
                ...
                // CSS Classes Props
                classProps="w-full rounded border-y border-r shadow px-4 py-2 border-l-8 border-l-red-600 focus:text-gray-700 focus:bg-white focus:border-red-600 focus:outline-none transition-all duration-300"
              />
              {/* --- */}
            </div>
            {/* --- */}
            ...
            <div className="w-full rounded border-y border-r shadow px-4 py-2 border-l-8 border-l-gray-500 relative">
              ...
              <span className="absolute text-xs bg-white font-semibold px-2 -top-2 left-0">Guests</span>
                  ...
                  <div className="bg-white shadow-md w-full p-4 space-y-2 relative">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Input
                        ...
                        classProps="w-14 rounded border p-1 text-center focus:text-gray-700 focus:bg-white focus:outline-none transition-all duration-300"
                      />
                      {/* --- */}
                    </div>
                    {/* --- */}
          ...
          <div className="lg:col-span-3">
            <div className="w-full border shadow mt-2 p-2">
              <div className="relative">
                {/* Using a gradient background instead of the missing image */}
                <div className="w-full h-20 lg:h-40 bg-gradient-to-r from-cyan-500 to-blue-500 flex items-center justify-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="absolute w-full h-full top-0 flex items-center justify-center">
                  {/* Rounte Link */}
                  <button
                    className="bg-white rounded-sm border border-black py-2 px-4 hover:bg-black hover:text-white transition-colors duration-300"
                    // Click event
                    onClick={() => {
